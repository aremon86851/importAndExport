      ...
      <div className="grid md:grid-cols-2 grid-cols-1 gap-5 lg:items-center items-start bg-white md:p-10 p-5 rounded-lg shadow">
        ...
        <div className="flex flex-col justify-between lg:p-4 pt-0 leading-normal">
          ...
          <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
            ...
            interactions with clients and associates are built on transparency,
            honesty, and ethical procedures.
          </p>
          <p className="md:mb-3 mb-0 font-normal text-gray-700 dark:text-gray-400">
            Our continuous dedication to providing exceptional customer service
            and cultivating long-term relationships is balanced by our
            unwavering emphasis on maintaining tight quality controls, assuring
